...
const PlaylistModal = ({
  ...
  const [showAuthorsDirectoryModal, setShowAuthorsDirectoryModal] = useState(false);
  const [selectedAuthorDirectory, setSelectedAuthorDirectory] = useState(
    authorsData[0] || null,
  );
  const [showSocialModal, setShowSocialModal] = useState(false);
  const [socialTargetTrack, setSocialTargetTrack] = useState(null);
    ...
    <div style={{ width: "100%" }}>
      ...
      >
        <ControlsContainer>
          <button
            onClick={() => {
              setSelectedAuthorDirectory(authorsData[0] || null);
              setShowAuthorsDirectoryModal(true);
            }}
            style={{
              background: "black",
              color: "white",
      ...
      <AnimatePresence>
        {showAuthorsDirectoryModal && (
          <ModalOverlay
            onClick={() => setShowAuthorsDirectoryModal(false)}
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          >
                  ...
                  >
                    {authorsData.map((authorMeta) => (
                      <button
                        ...
                        onClick={() => setSelectedAuthorDirectory(authorMeta)}
                        style={{
                          width: "100%",
                          background:
                            selectedAuthorDirectory?.author === authorMeta.author
                  ...
                  {selectedAuthorDirectory ? (
                    <>
                      ...
                      >
                        ...
                        >
                          {selectedAuthorDirectory.author}
                        </h4>
                      </div>
                      ...
                      >
                        {selectedAuthorDirectory.info || "Опис автора відсутній."}
                      </div>

                      {(selectedAuthorDirectory.linkkone ||
                        selectedAuthorDirectory.linknameoneone ||
                        selectedAuthorDirectory.linknameonetwo) && (
                        <div
                          style={{
                            marginTop: "18px",
                            display: "flex",
                        ...
                        >
                          {selectedAuthorDirectory.linkkone && (
                            <a
                              href={selectedAuthorDirectory.linkkone}
                              target="_blank"
                              rel="noreferrer"
                              style={{
                            ...
                            >
                              {selectedAuthorDirectory.linknameoneone || "Джерело"}
                            </a>
                          )}
                      ...
                      {(selectedAuthorDirectory["Замітка"] ||
                        selectedAuthorDirectory["Примітка"]) && (
                        <div
                          style={{
                            marginTop: "18px",
                            padding: "12px 14px",
...
const MusicPhoto = ({
  ...
  onUpdateUser,
  onFsToggle,
  isAuthorsDirectoryOpen,
  onCloseAuthorsDirectory,
}) => {
