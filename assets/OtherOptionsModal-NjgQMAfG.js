import{o as Pe}from"./rolldown-runtime-BNNRdYrd.js";import{P as Ge,Rn as C,Vn as l,nr as Je,rr as Ye}from"./vendor-react-DiGU5HTv.js";import{t as Ke}from"./songAiKnowledge-DCl-r1aV.js";import{a as He,o as Te,r as ae,s as Xe}from"./index-B4ZN3846.js";var p=Pe(Je()),j=[{id:1,name:"Динофроз",file:Xe,type:"base"},{id:126,name:"Monody",file:Te,type:"base"},{id:285,name:"Unity",file:He,type:"base"}],Ve=new Set(j.map(t=>t.file)),re=t=>!!t&&Ve.has(t),oe="bg-audio-cache",Qe=()=>{if(typeof window>"u")return[];try{const t=window.localStorage.getItem("bg_music_soft_deleted_ids");return t?JSON.parse(t):[]}catch{return[]}},Ze=(t=[])=>{if(!(typeof window>"u"))try{window.localStorage.setItem("bg_music_soft_deleted_ids",JSON.stringify(Array.from(new Set(t))))}catch{}},n=Ye(),Be=C`
...
`,fe=()=>(0,n.jsxs)(pi,{children:[(0,n.jsx)(U,{$dur:.6,$delay:0}),(0,n.jsx)(U,{$dur:.8,$delay:.2}),(0,n.jsx)(U,{$dur:.7,$delay:.1})]}),fi=l.span`
  font-size: 12px;
